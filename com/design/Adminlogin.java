...
public class Adminlogin {
	...
	public JFrame getFrmAdminLogin() {
		return frmAdminLogin;
	}

	public void setFrmAdminLogin(JFrame frmAdminLogin) {
	...
	public void initialize() {
		...
		mntmAdminLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				obj.getFrmAdminLogin().setVisible(true);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\jeewan\\eclipse-workspace\\MBS\\src\\img\\img.jpg"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\jeewan\\eclipse-workspace\\MBS\\src\\img\\admin.gif"));
